            ...
            <div className="col-lg-6">
              <div className="pr50 pr0-xl mb30-md position-relative">
                <h1 className="animate-up-1 mb15 text-thm2">
                  Welcome to{" "}
                  <span className="text-thm">ProContractorsPlus.com</span>{" "}
                  <br className="d-none d-xl-block" />
                </h1>
                <p className="animate-up-2 ff-heading mb30 text">
                  – Your Ultimate Hub for Exceptional Contractor Services!
                </p>
                ...
                <div className="d-block d-md-flex mt30 banner-text animate-up-4">
                  <p className="hero-text fz15 me-2 mb-0 text">
                    Discover the easiest way to connect with top-quality
                    contractors for your home or business needs.
                    ProContractorsPlus.com is your dynamic online platform that
                    redefines the way you manage projects. Whether you're a
                    homeowner looking to renovate or a business in need of
                    expert services, we've got you covered.
                  </p>
                  {/* {popular.map((elm, i) => (
